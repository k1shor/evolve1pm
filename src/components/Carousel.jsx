    ...
    return (
        <>
            <div style={{ width: "90%", margin: "auto" }}>
                <Carousel width={'100%'} axis='vertical' infiniteLoop
                    style={{ margin: "auto" }}>
                    ...
                    <div>
                        <img src="src/assets/carousel/3.png" />
                ...
                <div id="default-carousel" className="relative w-full" data-carousel="slide">
                    ...
                    <div className="relative h-56 overflow-hidden rounded-lg md:h-96">
                        ...
                        <div className="hidden duration-700 ease-in-out" dataCarouselItem>
                            <img src={'../assets/carousel/1.jpeg'} className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
                        </div>
                        {/* <!-- Item 2 --> */}
                        <div className="hidden duration-700 ease-in-out" dataCarouselItem>
